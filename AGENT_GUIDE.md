...
**Kết quả:** Agent sẽ đi từ Domain -> Data -> DI -> Test một cách tự động.
...
**Kết quả:** Agent tự động rà soát sự lệ thuộc (Impact Analysis), thiết kế mở rộng code cũ an toàn và bổ sung Unit Test tương ứng.
...
## 8. Học hỏi và Ghi chú sai lầm (Learning & Adaptation)
...
## 9. Khám phá Dự án mới (Project Discovery)
...
## 10. Tối ưu Hiệu năng (Performance Tuning)
...
## 11. Trả Nợ Kỹ Thuật (Tech-Debt Bản Trì)
...
## 12. Cài đặt CI/CD Mặc định (Automation)
...
## 13. Nâng SDK & Google Play Policy (SDK Update)
...
## 14. Nâng Mức Tối Thiểu & Dọn Code Cũ (minSDK Cleanup)
...
*   **Sử dụng ký hiệu @:** Để triệu hồi các kỹ năng chuyên biệt. Ví dụ: "Dùng @compose-ui-system để vẽ màn hình Login."
