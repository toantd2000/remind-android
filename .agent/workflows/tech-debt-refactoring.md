...
## Bước 4: Kiểm chứng & Ghi vết (Verification & Logging Sync)
...
3. **Kích hoạt `@logwork-update`:** BẮT BUỘC lưu lại các TDR quan trọng vào `LOGWORK.md`.
4. **Cập nhật ARCHITECTURE_MAP.md:** Nếu việc refactor làm thay đổi cấu trúc module.
5. **Cập nhật CHANGELOG.md:** Nếu việc refactor có ảnh hưởng đến tính năng hoặc hiệu năng rõ rệt.
6. **Kích hoạt `@learning-journal`:** Ghi lại các vấn đề phát sinh trong quá trình refactor.
