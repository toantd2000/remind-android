...
### [TDR-026] - Tối giản màn hình Cài đặt (Settings Screen Simplification)
- **Ngày thực hiện:** 2026-04-20
- **Trạng thái:** Accepted
- **Bối cảnh:** Màn hình cài đặt hiện tại chứa nhiều mục chưa được triển khai đầy đủ hoặc không cần thiết ở giai đoạn này. Cần làm gọn giao diện để tập trung vào các tính năng cốt lõi.
- **Quyết định:** 
  - Ẩn mục "Alarm setting" trong nhóm App Settings.
  - Ẩn hoàn toàn nhóm "Support" (QA, Rate, Share).
  - Mục đích: Các tính năng này sẽ được triển khai hoàn thiện ở các phase sau.
  - Chuẩn hóa hiển thị phiên bản ứng dụng: Chuyển từ dạng centered box sang `SettingsItem` (dòng đơn có icon) để đồng nhất với ngôn ngữ thiết kế chung của trang cài đặt. Loại bỏ divider dư thừa phía trên.
