...
- **Tiến Độ:** 100%
- **Ngày cập nhật cuối:** 2026-05-09
- **Phiên bản hiện tại:** 1.1.3 (Build 6)
...
+- **Quyết định:** 
+  - Sử dụng `ActivityResultContracts.OpenDocument` (SAF) để người dùng tự chọn file.
+  - Sử dụng `takePersistableUriPermission` để duy trì quyền truy cập file sau khi reboot.
++- **Hệ quả:** Đảm bảo quyền riêng tư tối đa (quyền tối thiểu), trải nghiệm mượt mà và nhạc chuông tự chọn hoạt động ổn định kể cả sau khi khởi động lại máy.
+
+### [TDR-048] - Tái cấu trúc mục Giới thiệu và Ghi công (Attributions & Credits)
+- **Ngày thực hiện:** 2026-05-09
+- **Trạng thái:** Accepted
+- **Bối cảnh:** Người dùng cần ghi công minh bạch cho các tài nguyên miễn phí (Storyset, OSS) và muốn có một không gian để gửi lời cảm ơn tới cộng đồng.
+- **Quyết định:** 
+  - Tạo màn hình `AttributionsScreen` tập trung toàn bộ thông tin ghi công.
+  - Di chuyển "Giấy phép nguồn mở" vào bên trong màn hình này để giữ giao diện Cài đặt chính tối giản.
+  - Tích hợp liên kết trực tiếp tới Storyset qua Custom Tabs.
+- **Hệ quả:** Giao diện chuyên nghiệp hơn, tuân thủ tốt các quy định về ghi công tài nguyên và tạo được thiện cảm với người dùng qua lời cảm ơn cá nhân.
...
- **Feature:** Thêm màn hình "Lời cảm ơn & Tài nguyên" (Attributions) để ghi công Storyset và các thư viện mã nguồn mở.
- **UX:** Tái cấu trúc mục Giới thiệu trong Cài đặt để gọn gàng hơn.
- **Content:** Bổ sung lời cảm ơn cá nhân từ tác giả tới các tài nguyên miễn phí.
