...
class ReminderRepositoryImpl @Inject constructor(
    ...
    override fun getReminderFlow(id: Long): Flow<Reminder?> {
        return reminderDao.getReminderFlow(id).map { it?.toModel() }
    }
    ...
    override suspend fun getMissionsForReminder(reminderId: Long): List<vn.io.litever.remind.core.model.Mission> {
        return missionDao.getMissionsForReminderSync(reminderId).map { it.toModel() }
    }
