...
**Kết quả:** Agent tự động sử dụng kỹ năng `@logwork-update` để rà soát session, tạo các bản ghi **Technical Decision Record (TDR)** chuẩn hóa, đánh dấu Phase hoàn thành và lưu trữ các "Rationale" (lý do) đằng sau kiến trúc vào `LOGWORK.md`.
...
*   **Sử dụng ký hiệu @:** Để gọi các Kỹ năng (Skill) đặc thù và ép AI phải làm theo phong cách dự án. Các skill nòng cốt bạn nên nhớ:
    ...
    *   `@logwork-update`: Tự động ghi lại các quyết định kiến trúc (TDR) vào nhật ký.
