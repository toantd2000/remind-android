...
### [TDR-038] - Hợp nhất Luồng Thêm Nhiệm Vụ (Unified Mission Addition Workflow)
- **Ngày thực hiện:** 2026-04-22
- **Trạng thái:** Accepted
- **Bối cảnh:** Trước đây, việc thêm nhiệm vụ bị rời rạc: chọn loại xong bị đóng sheet, cấu hình lại nằm ở màn hình khác. Người dùng yêu cầu trải nghiệm liền mạch hơn.
- **Quyết định:** 
  - Chuyển đổi `MissionSelectionBottomSheet` thành một trình điều hướng đa bước (Selection -> Configuration).
  - Mọi cấu hình cơ bản (như số lần lặp lại) được thực hiện trực tiếp bên trong Bottom Sheet.
  - Sử dụng `AnimatedContent` hoặc `Crossfade` để chuyển đổi trạng thái bên trong sheet mà không làm đóng sheet.
  - Chỉ đóng sheet khi người dùng nhấn "Finish" (Hoàn thành) hoặc chủ động hủy bỏ.
- **Hệ quả:** Tăng tốc độ thêm nhiệm vụ, giảm số lần chuyển màn hình và tạo cảm giác ứng dụng phản hồi nhanh (Smooth UX). Đồng thời hỗ trợ đầy đủ đa ngôn ngữ cho toàn bộ luồng này.
